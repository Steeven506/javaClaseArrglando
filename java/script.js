...
// pantalla - body
document.write(name);
document.getElementById("box_one").innerHTML = "<h1>Steeven Chacón</h1>"; // cuando uso innerHTML identifica que es h1 mientras el text no
document.getElementById("box_two").innerText = "<h1>s}Steeven Chacón</h1>";
//librerias
Swal.fire({
    icon : 'info',
    title: 'Steeven',
...
let array_mul = [
    {name:"Steeven", last_name: "Chacón", age: "54"},
    {name:"Arii", last_name: "Chacón", age: "56"},
    {name:"Alexis", last_name: "Chacón", age: "8"},
    {name:"Majito", last_name: "Chacón", age: "15"},
];
